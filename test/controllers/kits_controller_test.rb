...
class KitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kit" do
    assert_difference('Kit.count') do
      post kits_url, params: { kit: { experiment_id: @kit.experiment_id, image: @kit.image, name: @kit.name } }
    end
  ...
  test "should update kit" do
    patch kit_url(@kit), params: { kit: { experiment_id: @kit.experiment_id, image: @kit.image, name: @kit.name } }
