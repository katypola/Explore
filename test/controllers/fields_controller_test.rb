...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { image: @field.image, name: @field.name, overview: @field.overview } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { image: @field.image, name: @field.name, overview: @field.overview } }
