...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { field_id: @experiment.field_id, image: @experiment.image, overview: @experiment.overview, title: @experiment.title } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { field_id: @experiment.field_id, image: @experiment.image, overview: @experiment.overview, title: @experiment.title } }
